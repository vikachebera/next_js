...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\3 курс\\next_js\\my-next-app\\generate\\client-dev",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "D:\\3 курс\\next_js\\my-next-app\\prisma\\schema.dev.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generate/client-dev\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_DEV_URL\")\n}\n\nmodel User {\n  id        Int      @id @default(autoincrement())\n  email     String   @unique\n  name      String?\n  createdAt DateTime @default(now())\n  posts     Post[]\n}\n\nmodel Post {\n  id        Int      @id @default(autoincrement())\n  title     String\n  content   String?\n  published Boolean  @default(false)\n  authorId  Int\n  createdAt DateTime @default(now())\n  author    User     @relation(fields: [authorId], references: [id])\n}\n",
  "inlineSchemaHash": "bb26c4ee496012b733d70927d855c773b28a5bb0ff62dac823741ab03c6b5035",
  "copyEngine": true
}
config.dirname = '/'
...
config.injectableEdgeEnv = () => ({
  parsed: {
    DATABASE_DEV_URL: typeof globalThis !== 'undefined' && globalThis['DATABASE_DEV_URL'] || typeof process !== 'undefined' && process.env && process.env.DATABASE_DEV_URL || undefined
  }
})
